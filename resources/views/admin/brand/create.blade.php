...
@section('main')
    <div class="page-container">
        ...
        <form action='{{ route("brands.store") }}' method="post" class="form form-horizontal" id="form-brand-create" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row cl {{ $errors->has('brand_name') ? ' has-error' : '' }}">
                ...
                <div class="formControls col-xs-6 col-sm-6">
                    <input type="text" class="input-text" placeholder="品牌名称" name="brand_name">
            ...
            <div class="row cl {{ $errors->has('site_url') ? ' has-error' : '' }}">
                ...
                <div class="formControls col-xs-6 col-sm-6">
                    <input type="text" class="input-text" placeholder="品牌网址" name="site_url">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-6 col-sm-6">
                    <textarea name="brand_desc" cols="" rows="" class="textarea"  placeholder="品牌描述"></textarea>
