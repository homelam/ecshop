...
@section('main')
    <div class="page-container">
        ...
        <form action='{{ route("categories.store") }}' method="post" class="form form-horizontal" id="form-category-create">
            {{ csrf_field() }}
            ...
            <div class="row cl {{ $errors->has('cat_name') ? ' has-error' : '' }}">
                ...
                <div class="formControls col-xs-6 col-sm-6">
                    <input type="text" class="input-text" placeholder="分类名称" name="cat_name">
            ...
            <div class="row cl {{ $errors->has('is_show') ? ' has-error' : '' }}">
                ...
                <div class="mt-20 skin-minimal">
                    <div class="radio-box">
                        <input type="radio" id="is-show-1" name="is_show"  value="1" checked='checked' >
                        <label for="radio-1">是</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" id="is-show-2" name="is_show" value="0" >
            ...
            <div class="row cl {{ $errors->has('show_in_nav') ? ' has-error' : '' }}">
                ...
                <div class="mt-20 skin-minimal">
                    <div class="radio-box">
                        <input type="radio" id="radio-1" name="show_in_nav" value="1" >
                        <label for="radio-1">是</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" id="radio-2" name="show_in_nav" value="0" checked='checked' >
                        <label for="radio-2">否</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-6 col-sm-6">
                    <textarea name="cat_desc" cols="" rows="" class="textarea"  placeholder="分类描述"></textarea>
