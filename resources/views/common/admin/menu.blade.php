		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{ url('/admin/products/create') }}" data-title="添加商品" href="javascript:void(0)">添加新商品</a></li>
                    <li><a data-href="{{ route('category.index') }}" data-title="分类列表" href="javascript:void(0)">商品分类</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
